...
import com.example.appblog.activities.SignInActivity;
import com.example.appblog.activities.UsersActivity;
import com.example.appblog.databinding.ActivityHomeChatBinding;
...
//                .addOnSuccessListener(unused -> showToast("Token updated successfully"))
    ...
    private  void signOut(){
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("unable to sign put"));
